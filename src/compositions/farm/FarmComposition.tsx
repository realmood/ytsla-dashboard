      ...
      <Container>
        <div className='flex-v screen-center'>
          ...
          <div className='center-h wp-100 mt-30 home-container'>
            <PoolCard stakingToken={Config.MemeToken} picture={Farm1Icon} poolUrl='/farm-meme' apy={0} rewardPercent={16.33} />
            <PoolCard stakingToken={Config.UniToken} picture={Farm2Icon} poolUrl='/farm-uni' apy={0} rewardPercent={16.33} />
            <PoolCard stakingToken={Config.UniLpToken} picture={Farm3Icon} poolUrl='/farm-lp' apy={0} rewardPercent={67.34} />
          </div>
        </div>
      </Container>
      <Footer />
